...
{
    int array1[11] = {1, 5, 7, 5, 8, 9, 11, 11, 2, 5, 6}; // Declaration and initialization of the array
    // int s1 = sizeof(array1) / sizeof(array1[0]); // Calculate the size of the array

    cout << "Original array: "; // Output label for original array

    for (int i = 0; i < 11; i++) // Loop to output elements of the original array
        cout << array1[i] << " ";

    cout << "\nUnique elements of the said array: "; // Output label for unique elements

    for (int i = 0; i < 11; i++) // Loop to find and output unique elements
    {
        int j;
